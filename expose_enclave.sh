...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:ap-southeast-2:289956717962:secret:weather-api-D35Wcl --region ap-southeast-2 | jq -r .SecretString)
